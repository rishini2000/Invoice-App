...
public class InvoiceAppV7{
    ...
    public static void main(String[]args){
        ...
        List <Customer> cuscodelist = CustomerDao.getCustomer(custmcode);
        for(Customer cus:cuscodelist){
            
            cusname = cus.getName();
            cusdiscount = cus.getDiscount();
        ...
        List <Item> itmlist = ItemDao.getItem(itemcode);
